    ...
    'columns' => [
        ...
        'product' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => ' AND ((\'###PAGE_TSCONFIG_IDLIST###\' <> \'0\' AND FIND_IN_SET(tx_rkwshop_domain_model_product.pid,\'###PAGE_TSCONFIG_IDLIST###\')) OR (\'###PAGE_TSCONFIG_IDLIST###\' = \'0\')) AND tx_rkwshop_domain_model_product.hidden = 0 AND tx_rkwshop_domain_model_product.deleted = 0 ORDER BY tx_rkwshop_domain_model_product.title ASC',
                'size' => 1,
                'minitems' => 0,
                'maxitems' => 1,
            ],
        ...
        'event' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => ' AND ((\'###PAGE_TSCONFIG_IDLIST###\' <> \'0\' AND FIND_IN_SET(tx_rkwevents_domain_model_event.pid,\'###PAGE_TSCONFIG_IDLIST###\')) OR (\'###PAGE_TSCONFIG_IDLIST###\' = \'0\')) AND tx_rkwevents_domain_model_event.hidden = 0 AND tx_rkwevents_domain_model_event.deleted = 0 ORDER BY tx_rkwevents_domain_model_event.start DESC',
                'size' => 1,
                'minitems' => 0,
                'maxitems' => 1,
            ],
